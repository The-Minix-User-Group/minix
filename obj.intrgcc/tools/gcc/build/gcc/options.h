...
#endif
#ifdef GENERATOR_FILE
extern int riscv_lra_flag;
#else
  int x_riscv_lra_flag;
#define riscv_lra_flag global_options.x_riscv_lra_flag
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Tbss_ = 138,                           /* -Tbss= */
  OPT_Tdata = 139,                           /* -Tdata */
  OPT_Tdata_ = 140,                          /* -Tdata= */
  OPT_Ttext = 141,                           /* -Ttext */
  OPT_Ttext_ = 142,                          /* -Ttext= */
  OPT_U = 143,                               /* -U */
  /* OPT_W = 144, */                         /* -W */
  OPT_Wa_ = 145,                             /* -Wa, */
  OPT_Wabi = 146,                            /* -Wabi */
  OPT_Wabi_tag = 147,                        /* -Wabi-tag */
  OPT_Waddress = 148,                        /* -Waddress */
  OPT_Waggregate_return = 149,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 150,  /* -Waggressive-loop-optimizations */
  OPT_Wall = 151,                            /* -Wall */
  OPT_Warray_bounds = 152,                   /* -Warray-bounds */
  ...
  /* OPT_Wc__11_compat = 159, */             /* -Wc++11-compat */
  OPT_Wcast_align = 160,                     /* -Wcast-align */
  OPT_Wcast_qual = 161,                      /* -Wcast-qual */
  OPT_Wchar_subscripts = 162,                /* -Wchar-subscripts */
  OPT_Wclobbered = 163,                      /* -Wclobbered */
  OPT_Wcomment = 164,                        /* -Wcomment */
  /* OPT_Wcomments = 165, */                 /* -Wcomments */
  OPT_Wconversion = 166,                     /* -Wconversion */
  OPT_Wconversion_null = 167,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 168,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 169,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 170,              /* -Wctor-dtor-privacy */
  OPT_Wdeclaration_after_statement = 171,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_non_virtual_dtor = 172,        /* -Wdelete-non-virtual-dtor */
  ...
  OPT_Wfree_nonheap_object = 197,            /* -Wfree-nonheap-object */
  OPT_Wignored_qualifiers = 198,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 199,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 200,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 201,                   /* -Wimplicit-int */
  /* OPT_Wimport = 202, */                   /* -Wimport */
  OPT_Winherited_variadic_ctor = 203,        /* -Winherited-variadic-ctor */
  OPT_Winit_self = 204,                      /* -Winit-self */
  OPT_Winline = 205,                         /* -Winline */
  OPT_Wint_to_pointer_cast = 206,            /* -Wint-to-pointer-cast */
  OPT_Winvalid_memory_model = 207,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 208,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 209,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 210,               /* -Wjump-misses-init */
  OPT_Wl_ = 211,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 212, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 213,                   /* -Wlarger-than= */
  OPT_Wliteral_suffix = 214,                 /* -Wliteral-suffix */
  OPT_Wlogical_op = 215,                     /* -Wlogical-op */
  OPT_Wlong_long = 216,                      /* -Wlong-long */
  OPT_Wmain = 217,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 218,            /* -Wmaybe-uninitialized */
  ...
  OPT_Wnarrowing = 229,                      /* -Wnarrowing */
  OPT_Wnested_externs = 230,                 /* -Wnested-externs */
  OPT_Wnoexcept = 231,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 232,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 233,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 234,                        /* -Wnonnull */
  OPT_Wnormalized_ = 235,                    /* -Wnormalized= */
  OPT_Wold_style_cast = 236,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 237,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 238,           /* -Wold-style-definition */
  OPT_Woverflow = 239,                       /* -Woverflow */
  OPT_Woverlength_strings = 240,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 241,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 242,                  /* -Woverride-init */
  OPT_Wp_ = 243,                             /* -Wp, */
  OPT_Wpacked = 244,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 245,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 246,                         /* -Wpadded */
  OPT_Wparentheses = 247,                    /* -Wparentheses */
  OPT_Wpedantic = 248,                       /* -Wpedantic */
  OPT_Wpmf_conversions = 249,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 250,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 251,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 252,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 253,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 254,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 255,                       /* -Wprotocol */
  OPT_Wpsabi = 256,                          /* -Wpsabi */
  OPT_Wredundant_decls = 257,                /* -Wredundant-decls */
  OPT_Wreorder = 258,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 259,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 260,                    /* -Wreturn-type */
  OPT_Wselector = 261,                       /* -Wselector */
  OPT_Wsequence_point = 262,                 /* -Wsequence-point */
  OPT_Wshadow = 263,                         /* -Wshadow */
  OPT_Wsign_compare = 264,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 265,                /* -Wsign-conversion */
  OPT_Wsign_promo = 266,                     /* -Wsign-promo */
  OPT_Wsizeof_pointer_memaccess = 267,       /* -Wsizeof-pointer-memaccess */
  OPT_Wstack_protector = 268,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 269,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 270,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 271,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 272,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 273,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 274,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 275,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 276,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 277,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 278,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 279,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 280,         /* -Wsuggest-attribute=pure */
  OPT_Wswitch = 281,                         /* -Wswitch */
  OPT_Wswitch_default = 282,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 283,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 284,                      /* -Wsync-nand */
  OPT_Wsynth = 285,                          /* -Wsynth */
  OPT_Wsystem_headers = 286,                 /* -Wsystem-headers */
  OPT_Wtraditional = 287,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 288,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 289,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 290,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 291,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 292,            /* -Wundeclared-selector */
  OPT_Wundef = 293,                          /* -Wundef */
  OPT_Wuninitialized = 294,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 295,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 296, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 297,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 298,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 299,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 300,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 301,        /* -Wunused-but-set-variable */
  OPT_Wunused_function = 302,                /* -Wunused-function */
  OPT_Wunused_label = 303,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 304,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 305,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 306,               /* -Wunused-parameter */
  OPT_Wunused_result = 307,                  /* -Wunused-result */
  OPT_Wunused_value = 308,                   /* -Wunused-value */
  OPT_Wunused_variable = 309,                /* -Wunused-variable */
  OPT_Wuseless_cast = 310,                   /* -Wuseless-cast */
  OPT_Wvarargs = 311,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 312,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 313,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 314,            /* -Wvirtual-move-assign */
  OPT_Wvla = 315,                            /* -Wvla */
  OPT_Wvolatile_register_var = 316,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 317,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 318,  /* -Wzero-as-null-pointer-constant */
  OPT_Xassembler = 319,                      /* -Xassembler */
  OPT_Xlinker = 320,                         /* -Xlinker */
  OPT_Xpreprocessor = 321,                   /* -Xpreprocessor */
  OPT_Z = 322,                               /* -Z */
  OPT_ansi = 323,                            /* -ansi */
  OPT_assert_ = 324,                         /* -assert= */
  OPT_aux_info = 325,                        /* -aux-info */
  /* OPT_aux_info_ = 326, */                 /* -aux-info= */
  OPT_auxbase = 327,                         /* -auxbase */
  OPT_auxbase_strip = 328,                   /* -auxbase-strip */
  OPT_c = 329,                               /* -c */
  OPT_coverage = 330,                        /* -coverage */
  OPT_cxx_isystem = 331,                     /* -cxx-isystem */
  OPT_d = 332,                               /* -d */
  OPT_dumpbase = 333,                        /* -dumpbase */
  OPT_dumpdir = 334,                         /* -dumpdir */
  OPT_dumpmachine = 335,                     /* -dumpmachine */
  OPT_dumpspecs = 336,                       /* -dumpspecs */
  OPT_dumpversion = 337,                     /* -dumpversion */
  OPT_e = 338,                               /* -e */
  OPT_export_dynamic = 339,                  /* -export-dynamic */
  OPT_fPIC = 340,                            /* -fPIC */
  OPT_fPIE = 341,                            /* -fPIE */
  OPT_fabi_version_ = 342,                   /* -fabi-version= */
  OPT_faccess_control = 343,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 344,               /* -fada-spec-parent= */
  OPT_faggressive_loop_optimizations = 345,  /* -faggressive-loop-optimizations */
  OPT_falign_functions = 346,                /* -falign-functions */
  OPT_falign_functions_ = 347,               /* -falign-functions= */
  OPT_falign_jumps = 348,                    /* -falign-jumps */
  OPT_falign_jumps_ = 349,                   /* -falign-jumps= */
  OPT_falign_labels = 350,                   /* -falign-labels */
  OPT_falign_labels_ = 351,                  /* -falign-labels= */
  OPT_falign_loops = 352,                    /* -falign-loops */
  OPT_falign_loops_ = 353,                   /* -falign-loops= */
  /* OPT_fall_virtual = 354, */              /* -fall-virtual */
  OPT_fallow_parameterless_variadic_functions = 355,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 356, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 357, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 358, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 359, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 360, */  /* -fargument-noalias-global */
  OPT_fasm = 361,                            /* -fasm */
  OPT_fassociative_math = 362,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 363,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 364,                   /* -fauto-inc-dec */
  OPT_fbounds_check = 365,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 366,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 367,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 368,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 369,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 370,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 371,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 372,                        /* -fbuiltin */
  OPT_fbuiltin_ = 373,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 374,                    /* -fcall-saved- */
  OPT_fcall_used_ = 375,                     /* -fcall-used- */
  OPT_fcaller_saves = 376,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 377,       /* -fcanonical-system-headers */
  OPT_fcheck_data_deps = 378,                /* -fcheck-data-deps */
  OPT_fcheck_new = 379,                      /* -fcheck-new */
  OPT_fcombine_stack_adjustments = 380,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 381,                         /* -fcommon */
  OPT_fcompare_debug = 382,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 383,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 384,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 385,                   /* -fcompare-elim */
  OPT_fcond_mismatch = 386,                  /* -fcond-mismatch */
  OPT_fconserve_space = 387,                 /* -fconserve-space */
  OPT_fconserve_stack = 388,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 389,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 390,               /* -fconstexpr-depth= */
  OPT_fcprop_registers = 391,                /* -fcprop-registers */
  OPT_fcrossjumping = 392,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 393,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 394, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 395,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 396,               /* -fcx-limited-range */
  OPT_fdata_sections = 397,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 398,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 399,                       /* -fdbg-cnt= */
  OPT_fdce = 400,                            /* -fdce */
  OPT_fdebug_cpp = 401,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 402,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 403,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 404,               /* -fdeduce-init-list */
  /* OPT_fdefault_inline = 405, */           /* -fdefault-inline */
  OPT_fdefer_pop = 406,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 407,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 408,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 409,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 410,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 411,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 412,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 413,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 414,                /* -fdirectives-only */
  OPT_fdisable_ = 415,                       /* -fdisable- */
  OPT_fdollars_in_identifiers = 416,         /* -fdollars-in-identifiers */
  OPT_fdse = 417,                            /* -fdse */
  OPT_fdump_ = 418,                          /* -fdump- */
  OPT_fdump_ada_spec = 419,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 420,             /* -fdump-ada-spec-slim */
  OPT_fdump_final_insns = 421,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 422,              /* -fdump-final-insns= */
  OPT_fdump_go_spec_ = 423,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 424,                    /* -fdump-noaddr */
  OPT_fdump_passes = 425,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 426,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 427,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 428,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 429,                 /* -fearly-inlining */
  OPT_felide_constructors = 430,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 431,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 432, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 433,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 434,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 435,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 436,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 437,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 438,                        /* -fenable- */
  OPT_fenforce_eh_specs = 439,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 440, */           /* -fenum-int-equiv */
  OPT_fexceptions = 441,                     /* -fexceptions */
  OPT_fexcess_precision_ = 442,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 443,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 444,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 445,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 446,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 447,                /* -fextern-tls-init */
  /* OPT_fexternal_templates = 448, */       /* -fexternal-templates */
  OPT_ffast_math = 449,                      /* -ffast-math */
  OPT_ffat_lto_objects = 450,                /* -ffat-lto-objects */
  OPT_ffinite_math_only = 451,               /* -ffinite-math-only */
  OPT_ffixed_ = 452,                         /* -ffixed- */
  OPT_ffloat_store = 453,                    /* -ffloat-store */
  OPT_ffor_scope = 454,                      /* -ffor-scope */
  /* OPT_fforce_addr = 455, */               /* -fforce-addr */
  OPT_fforward_propagate = 456,              /* -fforward-propagate */
  OPT_ffp_contract_ = 457,                   /* -ffp-contract= */
  OPT_ffreestanding = 458,                   /* -ffreestanding */
  OPT_ffriend_injection = 459,               /* -ffriend-injection */
  OPT_ffunction_cse = 460,                   /* -ffunction-cse */
  OPT_ffunction_sections = 461,              /* -ffunction-sections */
  OPT_fgcse = 462,                           /* -fgcse */
  OPT_fgcse_after_reload = 463,              /* -fgcse-after-reload */
  OPT_fgcse_las = 464,                       /* -fgcse-las */
  OPT_fgcse_lm = 465,                        /* -fgcse-lm */
  OPT_fgcse_sm = 466,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 467,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 468,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 469,                         /* -fgnu-tm */
  OPT_fgnu_unique = 470,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 471,                   /* -fgnu89-inline */
  OPT_fgraphite = 472,                       /* -fgraphite */
  OPT_fgraphite_identity = 473,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 474,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 475, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 476, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 477, */                     /* -fhelp */
  /* OPT_fhelp_ = 478, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 479,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 480, */                /* -fhonor-std */
  OPT_fhosted = 481,                         /* -fhosted */
  /* OPT_fhuge_objects = 482, */             /* -fhuge-objects */
  OPT_fident = 483,                          /* -fident */
  OPT_fif_conversion = 484,                  /* -fif-conversion */
  OPT_fif_conversion2 = 485,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 486,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 487,      /* -fimplicit-inline-templates */
  OPT_fimplicit_templates = 488,             /* -fimplicit-templates */
  OPT_findirect_inlining = 489,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 490,         /* -finhibit-size-directive */
  OPT_finline = 491,                         /* -finline */
  OPT_finline_atomics = 492,                 /* -finline-atomics */
  OPT_finline_functions = 493,               /* -finline-functions */
  OPT_finline_functions_called_once = 494,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 495, */            /* -finline-limit- */
  OPT_finline_limit_ = 496,                  /* -finline-limit= */
  OPT_finline_small_functions = 497,         /* -finline-small-functions */
  OPT_finput_charset_ = 498,                 /* -finput-charset= */
  OPT_finstrument_functions = 499,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 500,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 501,/* -finstrument-functions-exclude-function-list= */
  OPT_fipa_cp = 502,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 503,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 504, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 505,                    /* -fipa-profile */
  OPT_fipa_pta = 506,                        /* -fipa-pta */
  OPT_fipa_pure_const = 507,                 /* -fipa-pure-const */
  OPT_fipa_reference = 508,                  /* -fipa-reference */
  OPT_fipa_sra = 509,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 510, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 511,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 512,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 513,              /* -fira-loop-pressure */
  OPT_fira_region_ = 514,                    /* -fira-region= */
  OPT_fira_share_save_slots = 515,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 516,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 517,                   /* -fira-verbose= */
  OPT_fivopts = 518,                         /* -fivopts */
  OPT_fjump_tables = 519,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 520,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 521,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 522,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 523, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 524,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 525,             /* -fleading-underscore */
  OPT_floop_block = 526,                     /* -floop-block */
  /* OPT_floop_flatten = 527, */             /* -floop-flatten */
  OPT_floop_interchange = 528,               /* -floop-interchange */
  OPT_floop_nest_optimize = 529,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 530, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 531,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 532,                /* -floop-strip-mine */
  OPT_flto = 533,                            /* -flto */
  OPT_flto_compression_level_ = 534,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 535,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 536,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 537,              /* -flto-partition=max */
  OPT_flto_partition_none = 538,             /* -flto-partition=none */
  OPT_flto_report = 539,                     /* -flto-report */
  OPT_flto_ = 540,                           /* -flto= */
  OPT_fltrans = 541,                         /* -fltrans */
  OPT_fltrans_output_list_ = 542,            /* -fltrans-output-list= */
  OPT_fmath_errno = 543,                     /* -fmath-errno */
  OPT_fmax_errors_ = 544,                    /* -fmax-errors= */
  OPT_fmem_report = 545,                     /* -fmem-report */
  OPT_fmem_report_wpa = 546,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 547,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 548,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 549,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 550,                /* -fmessage-length= */
  OPT_fmodulo_sched = 551,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 552,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 553,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 554,                  /* -fms-extensions */
  OPT_fmudflap = 555,                        /* -fmudflap */
  OPT_fmudflapir = 556,                      /* -fmudflapir */
  OPT_fmudflapth = 557,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 558, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 559, */                  /* -fnew-abi */
  OPT_fnext_runtime = 560,                   /* -fnext-runtime */
  OPT_fnil_receivers = 561,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 562,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 563,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 564, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 565,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 566,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 567,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 568,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 569,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 570,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 571,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 572,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 573,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 574,             /* -fomit-frame-pointer */
  OPT_fopenmp = 575,                         /* -fopenmp */
  OPT_foperator_names = 576,                 /* -foperator-names */
  OPT_fopt_info = 577,                       /* -fopt-info */
  OPT_fopt_info_ = 578,                      /* -fopt-info- */
  OPT_foptimize_register_move = 579,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 580,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 581,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 582, */           /* -foptional-diags */
  OPT_fpack_struct = 583,                    /* -fpack-struct */
  OPT_fpack_struct_ = 584,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 585,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 586,              /* -fpcc-struct-return */
  OPT_fpch_deps = 587,                       /* -fpch-deps */
  OPT_fpch_preprocess = 588,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 589,                     /* -fpeel-loops */
  OPT_fpeephole = 590,                       /* -fpeephole */
  OPT_fpeephole2 = 591,                      /* -fpeephole2 */
  OPT_fpermissive = 592,                     /* -fpermissive */
  OPT_fpic = 593,                            /* -fpic */
  OPT_fpie = 594,                            /* -fpie */
  OPT_fplan9_extensions = 595,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 596,                    /* -fplugin-arg- */
  OPT_fplugin_ = 597,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 598,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 599,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 600,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 601,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 602,                   /* -fpreprocessed */
  OPT_fpretty_templates = 603,               /* -fpretty-templates */
  OPT_fprofile = 604,                        /* -fprofile */
  OPT_fprofile_arcs = 605,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 606,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 607,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 608,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 609,              /* -fprofile-generate= */
  OPT_fprofile_report = 610,                 /* -fprofile-report */
  OPT_fprofile_use = 611,                    /* -fprofile-use */
  OPT_fprofile_use_ = 612,                   /* -fprofile-use= */
  OPT_fprofile_values = 613,                 /* -fprofile-values */
  OPT_frandom_seed = 614,                    /* -frandom-seed */
  OPT_frandom_seed_ = 615,                   /* -frandom-seed= */
  OPT_freciprocal_math = 616,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 617,            /* -frecord-gcc-switches */
  OPT_free = 618,                            /* -free */
  OPT_freg_struct_return = 619,              /* -freg-struct-return */
  OPT_fregmove = 620,                        /* -fregmove */
  OPT_frename_registers = 621,               /* -frename-registers */
  OPT_freorder_blocks = 622,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 623,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 624,              /* -freorder-functions */
  OPT_freplace_objc_classes = 625,           /* -freplace-objc-classes */
  OPT_frepo = 626,                           /* -frepo */
  OPT_frerun_cse_after_loop = 627,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 628, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 629,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 630,                    /* -fresolution= */
  OPT_frounding_math = 631,                  /* -frounding-math */
  OPT_frtti = 632,                           /* -frtti */
  OPT_fsanitize_address = 633,               /* -fsanitize=address */
  OPT_fsanitize_thread = 634,                /* -fsanitize=thread */
  OPT_fsched_critical_path_heuristic = 635,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 636,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 637,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 638,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 639,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 640,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 641,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 642,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 643,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 644,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 645,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 646,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 647,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 648,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 649,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 650,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 651,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 652, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 653,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 654,                /* -fschedule-insns2 */
  OPT_fsection_anchors = 655,                /* -fsection-anchors */
  /* OPT_fsee = 656, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 657,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 658,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 659, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 660,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 661,          /* -fselective-scheduling2 */
  OPT_fshort_double = 662,                   /* -fshort-double */
  OPT_fshort_enums = 663,                    /* -fshort-enums */
  OPT_fshort_wchar = 664,                    /* -fshort-wchar */
  OPT_fshow_column = 665,                    /* -fshow-column */
  OPT_fshrink_wrap = 666,                    /* -fshrink-wrap */
  OPT_fsignaling_nans = 667,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 668,               /* -fsigned-bitfields */
  OPT_fsigned_char = 669,                    /* -fsigned-char */
  OPT_fsigned_zeros = 670,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 671,      /* -fsingle-precision-constant */
  OPT_fsplit_ivs_in_unroller = 672,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 673,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 674,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 675, */                 /* -fsquangle */
  /* OPT_fstack_check = 676, */              /* -fstack-check */
  OPT_fstack_check_ = 677,                   /* -fstack-check= */
  OPT_fstack_limit = 678,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 679,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 680,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 681,                /* -fstack-protector */
  OPT_fstack_protector_all = 682,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 683,                   /* -fstack-reuse= */
  OPT_fstack_usage = 684,                    /* -fstack-usage */
  OPT_fstats = 685,                          /* -fstats */
  /* OPT_fstrength_reduce = 686, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 687,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 688,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 689,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 690, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 691,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 692,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 693,                    /* -fsyntax-only */
  OPT_ftabstop_ = 694,                       /* -ftabstop= */
  /* OPT_ftarget_help = 695, */              /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 696,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 697, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 698,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 699,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 700, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 701,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 702,             /* -fthreadsafe-statics */
  OPT_ftime_report = 703,                    /* -ftime-report */
  OPT_ftls_model_ = 704,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 705,               /* -ftoplevel-reorder */
  OPT_ftracer = 706,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 707,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 708,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 709,                  /* -ftrapping-math */
  OPT_ftrapv = 710,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 711,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 712,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 713,                       /* -ftree-ccp */
  OPT_ftree_ch = 714,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 715,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 716,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 717,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 718,                /* -ftree-copyrename */
  OPT_ftree_cselim = 719,                    /* -ftree-cselim */
  OPT_ftree_dce = 720,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 721,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 722,                       /* -ftree-dse */
  OPT_ftree_forwprop = 723,                  /* -ftree-forwprop */
  OPT_ftree_fre = 724,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 725,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 726,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 727,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 728,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 729,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 730,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 731, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 732,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 733,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 734,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 735,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 736,                   /* -ftree-phiprop */
  OPT_ftree_pre = 737,                       /* -ftree-pre */
  OPT_ftree_pta = 738,                       /* -ftree-pta */
  OPT_ftree_reassoc = 739,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 740, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 741,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 742,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 743,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 744,                      /* -ftree-slsr */
  OPT_ftree_sra = 745,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 746, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 747, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 748,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 749,                /* -ftree-tail-merge */
  OPT_ftree_ter = 750,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 751,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 752,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 753,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 754,                       /* -ftree-vrp */
  OPT_funit_at_a_time = 755,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 756,               /* -funroll-all-loops */
  OPT_funroll_loops = 757,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 758,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 759,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 760,             /* -funsigned-bitfields */
  OPT_funsigned_char = 761,                  /* -funsigned-char */
  OPT_funswitch_loops = 762,                 /* -funswitch-loops */
  OPT_funwind_tables = 763,                  /* -funwind-tables */
  OPT_fuse_cxa_atexit = 764,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 765,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 766,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 767,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 768,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 769,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 770,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 771,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 772,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 773, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 774,                /* -fvect-cost-model */
  OPT_fverbose_asm = 775,                    /* -fverbose-asm */
  /* OPT_fversion = 776, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 777,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 778,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 779,                    /* -fvisibility= */
  OPT_fvpt = 780,                            /* -fvpt */
  /* OPT_fvtable_gc = 781, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 782, */            /* -fvtable-thunks */
  OPT_fweak = 783,                           /* -fweak */
  OPT_fweb = 784,                            /* -fweb */
  OPT_fwhole_program = 785,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 786,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 787,              /* -fworking-directory */
  OPT_fwpa = 788,                            /* -fwpa */
  OPT_fwrapv = 789,                          /* -fwrapv */
  /* OPT_fxref = 790, */                     /* -fxref */
  /* OPT_fzee = 791, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 792,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 793,                      /* -fzero-link */
  OPT_g = 794,                               /* -g */
  OPT_gcoff = 795,                           /* -gcoff */
  OPT_gdwarf_ = 796,                         /* -gdwarf- */
  OPT_gen_decls = 797,                       /* -gen-decls */
  OPT_ggdb = 798,                            /* -ggdb */
  OPT_gno_pubnames = 799,                    /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 800,         /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 801,                 /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 802,                /* -gno-strict-dwarf */
  OPT_gpubnames = 803,                       /* -gpubnames */
  OPT_grecord_gcc_switches = 804,            /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 805,                    /* -gsplit-dwarf */
  OPT_gstabs = 806,                          /* -gstabs */
  OPT_gstabs_ = 807,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 808,                   /* -gstrict-dwarf */
  OPT_gtoggle = 809,                         /* -gtoggle */
  OPT_gvms = 810,                            /* -gvms */
  OPT_gxcoff = 811,                          /* -gxcoff */
  OPT_gxcoff_ = 812,                         /* -gxcoff+ */
  OPT_h = 813,                               /* -h */
  OPT_idirafter = 814,                       /* -idirafter */
  OPT_imacros = 815,                         /* -imacros */
  OPT_imultiarch = 816,                      /* -imultiarch */
  ...
  OPT_iremap = 822,                          /* -iremap */
  OPT_isysroot = 823,                        /* -isysroot */
  OPT_isystem = 824,                         /* -isystem */
  OPT_iwithprefix = 825,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 826,               /* -iwithprefixbefore */
  OPT_l = 827,                               /* -l */
  OPT_lang_asm = 828,                        /* -lang-asm */
  OPT_m32 = 829,                             /* -m32 */
  OPT_m64 = 830,                             /* -m64 */
  OPT_march_ = 831,                          /* -march= */
  OPT_matomic = 832,                         /* -matomic */
  OPT_mbranch_cost_ = 833,                   /* -mbranch-cost= */
  OPT_mcmodel_ = 834,                        /* -mcmodel= */
  OPT_mfdiv = 835,                           /* -mfdiv */
  OPT_mhard_float = 836,                     /* -mhard-float */
  OPT_mlra = 837,                            /* -mlra */
  OPT_mmemcpy = 838,                         /* -mmemcpy */
  OPT_mmuldiv = 839,                         /* -mmuldiv */
  OPT_mplt = 840,                            /* -mplt */
  OPT_msmall_data_limit_ = 841,              /* -msmall-data-limit= */
  OPT_msoft_float = 842,                     /* -msoft-float */
  OPT_mtune_ = 843,                          /* -mtune= */
  OPT_n = 844,                               /* -n */
  OPT_no_canonical_prefixes = 845,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 846,               /* -no-integrated-cpp */
  OPT_nodefaultlibs = 847,                   /* -nodefaultlibs */
  OPT_nostartfiles = 848,                    /* -nostartfiles */
  OPT_nostdinc = 849,                        /* -nostdinc */
  OPT_nostdinc__ = 850,                      /* -nostdinc++ */
  OPT_nostdlib = 851,                        /* -nostdlib */
  OPT_o = 852,                               /* -o */
  OPT_p = 853,                               /* -p */
  OPT_pass_exit_codes = 854,                 /* -pass-exit-codes */
  /* OPT_pedantic = 855, */                  /* -pedantic */
  OPT_pedantic_errors = 856,                 /* -pedantic-errors */
  OPT_pg = 857,                              /* -pg */
  OPT_pie = 858,                             /* -pie */
  OPT_pipe = 859,                            /* -pipe */
  OPT_posix = 860,                           /* -posix */
  ...
  OPT_pthread = 872,                         /* -pthread */
  OPT_quiet = 873,                           /* -quiet */
  OPT_r = 874,                               /* -r */
  OPT_rdynamic = 875,                        /* -rdynamic */
  OPT_remap = 876,                           /* -remap */
  OPT_rpath_ = 877,                          /* -rpath= */
  OPT_s = 878,                               /* -s */
  OPT_save_temps = 879,                      /* -save-temps */
  OPT_save_temps_ = 880,                     /* -save-temps= */
  OPT_shared = 881,                          /* -shared */
  OPT_shared_libgcc = 882,                   /* -shared-libgcc */
  /* OPT_specs = 883, */                     /* -specs */
  OPT_specs_ = 884,                          /* -specs= */
  OPT_static = 885,                          /* -static */
  OPT_static_libasan = 886,                  /* -static-libasan */
  OPT_static_libgcc = 887,                   /* -static-libgcc */
  OPT_static_libgfortran = 888,              /* -static-libgfortran */
  OPT_static_libgo = 889,                    /* -static-libgo */
  OPT_static_libstdc__ = 890,                /* -static-libstdc++ */
  OPT_static_libtsan = 891,                  /* -static-libtsan */
  /* OPT_std_c__03 = 892, */                 /* -std=c++03 */
  /* OPT_std_c__0x = 893, */                 /* -std=c++0x */
  OPT_std_c__11 = 894,                       /* -std=c++11 */
  OPT_std_c__1y = 895,                       /* -std=c++1y */
  OPT_std_c__98 = 896,                       /* -std=c++98 */
  OPT_std_c11 = 897,                         /* -std=c11 */
  /* OPT_std_c1x = 898, */                   /* -std=c1x */
  /* OPT_std_c89 = 899, */                   /* -std=c89 */
  OPT_std_c90 = 900,                         /* -std=c90 */
  OPT_std_c99 = 901,                         /* -std=c99 */
  /* OPT_std_c9x = 902, */                   /* -std=c9x */
  /* OPT_std_gnu__03 = 903, */               /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 904, */               /* -std=gnu++0x */
  OPT_std_gnu__11 = 905,                     /* -std=gnu++11 */
  OPT_std_gnu__1y = 906,                     /* -std=gnu++1y */
  OPT_std_gnu__98 = 907,                     /* -std=gnu++98 */
  OPT_std_gnu11 = 908,                       /* -std=gnu11 */
  /* OPT_std_gnu1x = 909, */                 /* -std=gnu1x */
  /* OPT_std_gnu89 = 910, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 911,                       /* -std=gnu90 */
  OPT_std_gnu99 = 912,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 913, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 914, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 915,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 916, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 917, */          /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 918, */          /* -std=iso9899:2011 */
  OPT_symbolic = 919,                        /* -symbolic */
  OPT_t = 920,                               /* -t */
  OPT_time = 921,                            /* -time */
  OPT_time_ = 922,                           /* -time= */
  OPT_traditional = 923,                     /* -traditional */
  OPT_traditional_cpp = 924,                 /* -traditional-cpp */
  OPT_trigraphs = 925,                       /* -trigraphs */
  OPT_u = 926,                               /* -u */
  OPT_undef = 927,                           /* -undef */
  OPT_v = 928,                               /* -v */
  OPT_version = 929,                         /* -version */
  OPT_w = 930,                               /* -w */
  OPT_wrapper = 931,                         /* -wrapper */
  OPT_x = 932,                               /* -x */
  OPT_z = 933,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
