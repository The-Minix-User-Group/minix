...
init(void)
{
	...
	/* from /home/donz/minix/bin/sh/exec.c: */
	{
		hash_special_builtins();
	}

	/* from /home/donz/minix/bin/sh/input.c: */
	{
		basepf.nextc = basepf.buf = basebuf;
	}

	/* from /home/donz/minix/bin/sh/var.c: */
	{
		char **envp;
...
reset(void)
{
	...
	/* from /home/donz/minix/bin/sh/eval.c: */
	{
		reset_eval();
	}
	...
	/* from /home/donz/minix/bin/sh/parser.c: */
	{
		tokpushback = 0;
		checkkwd = 0;
	}

	/* from /home/donz/minix/bin/sh/redir.c: */
	{
		while (redirlist)
			popredir();
	}

	/* from /home/donz/minix/bin/sh/output.c: */
	{
		out1 = &output;
		out2 = &errout;
		if (memout.buf != NULL) {
...
initshellproc(void)
{
	...
	/* from /home/donz/minix/bin/sh/alias.c: */
	{
		rmaliases();
	}
	...
	/* from /home/donz/minix/bin/sh/jobs.c: */
	{
		backgndpid = -1;
#if JOBS
		jobctl = 0;
	...
	/* from /home/donz/minix/bin/sh/options.c: */
	{
		int i;
	...
	/* from /home/donz/minix/bin/sh/trap.c: */
	{
		char *sm;
